...
import crnn_torch.utils.util1 as util
...
def predict(img):
    ...
    # d = torch.exp(d)
    # print(d, acc)
    char_list, prob_list, single_positions = converter.decode(acc, predict_len.data, scale, raw=False)
    return [char_list, prob_list], single_positions
