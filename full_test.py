...
def single_ocr(document, img_name, start_page, new_url):
    ...
    while 1:
        ...
        images_json = requests.post('http://172.30.20.154:32011/text_predict', data=data)
    ...
    for index, j in enumerate(images):
        ...
        try:
            ...
            img = base64.b64encode(img.tostring())
            data = {'img': img}
            content = requests.post('http://172.30.20.154:32010/predict', data=data).json()[:2]
...
# img_name = Image.open('20160621 变更注册资本、变更股东1571298169.1711347__11.jpg')
# document = docx.Document()
# document.styles['Normal'].font.name = u'宋体'
# document.styles['Normal']._element.rPr.rFonts.set(qn('w:eastAsia'), u'宋体')
# document, position = single_ocr(document, img_name, 1, '1')
