...
BackGround = [255, 255, 255]
ImageRegion = [0, 0, 0]
NoiseRegion = [128, 128, 128]
GraphicRegion = [128, 0, 0]
ChartRegion = [192, 192, 128]
SeparatorRegion = [255, 69, 0]
TextRegion = [255, 0, 0]
six = [60, 40, 222]
seven = [128, 128, 0]
eight = [192, 128, 128]
...
eleven = [64, 64, 0]
twelve = [0, 128, 192]
# COLOR_DICT = np.array([ImageRegion, NoiseRegion, GraphicRegion, ChartRegion, SeparatorRegion, TextRegion])
# COLOR_DICT = np.array([[255, 255, 255], [255, 0, 0], [0, 255, 0], [0, 0, 255], [255, 255, 0], [0, 255, 255]])
...
class data_preprocess:
    ...
    def saveResult(self, npyfile, size, threshold=127):
